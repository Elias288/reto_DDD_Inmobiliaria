...
public class AddedOfferUseCase extends UseCase<RequestCommand<AddOffer>, ResponseEvents> {

    @Override
    public void executeUseCase(RequestCommand<AddOffer> addClientRequestCommand) {
        ...
        pairing.addOffer(command.getOfferDate());
