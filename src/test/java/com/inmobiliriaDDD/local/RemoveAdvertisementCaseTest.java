...
class RemoveAdvertisementCaseTest {

    @InjectMocks
    private RemovedAdvertisementUseCase useCase;
    ...
    void removeAdvertisement() {
        ...
        AdvertisementID advertisementID = AdvertisementID.of("fakeAdvertisementID");
        ...
        //assert
        var event = (AdvertisementRemoved) domainEvents.get(0);
